...
namespace BettaGH
{
    public class BettaGHComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public BettaGHComponent()
          : base("BettaGHComponent", "ASpi",
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("f5c45ffd-bdc4-49d3-b017-27f41d011ba2");
    }
}